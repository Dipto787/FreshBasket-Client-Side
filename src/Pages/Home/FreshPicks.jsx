...
const FreshPicks = () => {
    return (
        <div>
            ...
            <div className='bg-[#ffb524] relative mt-12'>
                <div className=' absolute right-[35%] flex items-center bg-[#ffffff] p-5 rounded-full top-28 '>
                ...
                <section className="">
                    <div className="container flex flex-col justify-between p-6 mx-auto md:flex-row">
